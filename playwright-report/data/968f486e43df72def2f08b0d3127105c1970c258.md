...
- generic [ref=f3e4]:
  - generic [ref=f3e5]:
    - generic [ref=f3e6]:
      - button "EN" [pressed] [ref=f3e7]
      - button "FIL" [ref=f3e8]
    - generic [ref=f3e9]:
      - img "eGovPH logo" [ref=f3e10]
      - generic [ref=f3e18]:
        - generic [ref=f3e19]: eGOVPH
        - generic [ref=f3e20]: Bagong Pilipinas
      - paragraph [ref=f3e21]: Your Government. One App.
      - paragraph [ref=f3e22]: Access over 1,000 government services from national agencies and local government units — all in one place.
  - generic [ref=f3e23]:
    - button "Log In" [ref=f3e24]
    - button "Create Account" [ref=f3e25]
    - button "Continue as Guest (eTravel only)" [ref=f3e26]
    - paragraph [ref=f3e27]: By continuing, you agree to our Terms of Service and Privacy Policy.
    - generic [ref=f3e28]: ⚠ Unofficial Research Prototype — Not the real eGovPH
```
